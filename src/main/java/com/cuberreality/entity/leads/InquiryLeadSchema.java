...
import static com.cuberreality.constant.Schema.INQUIRY_LEADS_SCHEMA;
import static com.cuberreality.constant.Schema.REFER_LEADS_SCHEMA;

@Data
@Document(INQUIRY_LEADS_SCHEMA)
public class InquiryLeadSchema {
    @Field("_id")
...
//    public String leadId;
    ...
    @Field("userPropertyId")
    public String userPropertyId;

    @Field("userLeadId")
    public String userLeadId;
    @Field("__approved")
